   ...
   <children>
      ...
      <AnchorPane maxHeight="25.0" minHeight="25.0" prefHeight="25.0" styleClass="anchorpane-menu">
         <children>
            ...
            <Button fx:id="listall" layoutX="90.0" layoutY="-4.0" mnemonicParsing="false" styleClass="button-menu" text="list all" AnchorPane.bottomAnchor="0.0" AnchorPane.leftAnchor="330.0" AnchorPane.topAnchor="0.0" />
            <Button fx:id="listoverdue" mnemonicParsing="false" styleClass="button-menu" text="list overdue" AnchorPane.bottomAnchor="0.0" AnchorPane.leftAnchor="410.0" AnchorPane.topAnchor="0.0" />
            <Button fx:id="listtmr" mnemonicParsing="false" styleClass="button-menu" text="list tomorrow" AnchorPane.bottomAnchor="0.0" AnchorPane.leftAnchor="520.0" AnchorPane.topAnchor="0.0" />
         </children>
      </AnchorPane>
